...
float g_textguiLineSpacing = 1.0f;
float g_textguiShadowStrength = 0.65f;
...
int APIENTRY wWinMain(HINSTANCE hI, HINSTANCE, LPWSTR, int nSC) {
    ...
    // ===== 启动信息 =====
    std::cout << "============================================" << std::endl;
    std::cout << "  StrikeSense 测试发布版 202607171843" << std::endl;
...
static void PaintAll(HWND hw, HDC hdc) {
    ...
    case PAGE_PROGRAM_SETTINGS: PaintProgramSettingsPage(g, cx, cw, H, hw); break;
    }
