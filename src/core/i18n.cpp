...
void i18n::Init() {
    ...
    cn["CSCRIPT_OPEN_DIR"] = L"打开目录"; en["CSCRIPT_OPEN_DIR"] = L"Open Dir";
    cn["CSCRIPT_EMPTY"] = L"暂无脚本。每页固定显示 3 个脚本。"; en["CSCRIPT_EMPTY"] = L"No scripts. Three scripts are shown per page.";
    cn["CSCRIPT_BIND"] = L"绑定按键"; en["CSCRIPT_BIND"] = L"Bind";
    cn["CSCRIPT_PRESS_KEY"] = L"请按键"; en["CSCRIPT_PRESS_KEY"] = L"Press key";
    cn["CSCRIPT_RELOAD"] = L"重载"; en["CSCRIPT_RELOAD"] = L"Reload";
    cn["CSCRIPT_REMOVE"] = L"卸载"; en["CSCRIPT_REMOVE"] = L"Remove";
    cn["CSCRIPT_PREVIOUS"] = L"上一页"; en["CSCRIPT_PREVIOUS"] = L"Previous";
    ...
    cn["CSCRIPT_UNSUPPORTED_KEY"] = L"该按键不在 CScript 单按键映射表中，请选择字母、数字、小键盘、Ctrl/Shift/Alt、Tab、CapsLock、方向键或常用功能键。";
    en["CSCRIPT_UNSUPPORTED_KEY"] = L"This key is not supported by the CScript single-key map.";
