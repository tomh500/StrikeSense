...
void i18n::Init() {
    ...
    cn[Keys::SIDEBAR_LEGAL] = L"合法配置"; en[Keys::SIDEBAR_LEGAL] = L"Legal Config";
    cn[Keys::SIDEBAR_OVERCLOCK] = L"超频配置"; en[Keys::SIDEBAR_OVERCLOCK] = L"Overclock";
    ...
    cn[Keys::LEGAL_TITLE] = L"合法配置"; en[Keys::LEGAL_TITLE] = L"Legal Config";
    ...
    cn[Keys::OVERCLOCK_TITLE] = L"超频配置"; en[Keys::OVERCLOCK_TITLE] = L"Overclock";
    cn[Keys::OVERCLOCK_PLACEHOLDER] = L"功能开发中..."; en[Keys::OVERCLOCK_PLACEHOLDER] = L"Coming soon...";
...
namespace i18n { namespace Keys {
    const char *SIDEBAR_FILE="SIDEBAR_FILE",*SIDEBAR_SETTINGS="SIDEBAR_SETTINGS",*SIDEBAR_EVOLUTION="SIDEBAR_EVOLUTION",*SIDEBAR_LEGAL="SIDEBAR_LEGAL",*SIDEBAR_OVERCLOCK="SIDEBAR_OVERCLOCK",*SIDEBAR_ITEMHELPER="SIDEBAR_ITEMHELPER";
    ...
    const char *OVERCLOCK_TITLE="OVERCLOCK_TITLE",*OVERCLOCK_PLACEHOLDER="OVERCLOCK_PLACEHOLDER";
